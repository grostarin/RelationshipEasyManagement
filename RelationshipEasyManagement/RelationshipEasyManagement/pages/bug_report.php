...
# along with MantisBT.  If not, see <http://www.gnu.org/licenses/>.
	...
	html_meta_redirect( string_get_bug_view_url( $f_master_bug_id ) );
...
<?php
	...
	print_bracket_link( string_get_bug_view_url( $f_master_bug_id ), sprintf( plugin_lang_get( 'view_master_bug_link' ), $f_master_bug_id ) );
